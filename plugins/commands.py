...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Dev", url="https://t.me/THOMAS_MOVIE_HUT")
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Channel", url="https://t.me/MOVIE_HUT_MALAYALAM"),
                    InlineKeyboardButton("Group", url="https://t.me/MOVIE_HUT_GROUP")
                ]
            ]
        ),
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/nokkiiru_nnoippokittum")
                ],
                [
